...
import 'package:tech_block/model/model.dart';

Map homePagePosterMap = {
  'writer': 'رضا عطایی',
  'view': 397,
  'title': 'دوازده قدم دوره برنامه نویسی فلاتر به همراه هوش مصنوعی ',
  'date': 'یک روز پیش',
  'imageAssets': Assets.images.bannerTest,
};

List<HashTagModel> listHashTagModel = [
  HashTagModel(title: 'طراحی سایت '),
  HashTagModel(title: 'فلاتر'),
  HashTagModel(title: 'هوش مصنوعی'),
  HashTagModel(title: 'پایتون'),
  HashTagModel(title: 'پادرکست رادیو فلاتر'),
  HashTagModel(title: 'جاوا'),
];

List<MaghalehModel> blogList = [
  MaghalehModel(
      id: 1,
      // hashtags:[HashTagModel(title: 'title')],
      imageUrl:
...
List<PadkastPosterModel> listPadkastPosterModel = [
  PadkastPosterModel(image: 'ramzon', title: 'رمزون'),
  PadkastPosterModel(image: 'radio-codeyad', title: 'رادیو کدیاد'),
  PadkastPosterModel(image: 'tecknost', title: 'تکنوکست'),
  PadkastPosterModel(image: 'padi-kast', title: 'پادی کست'),
];
